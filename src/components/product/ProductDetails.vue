            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="">
                                <img :src="product.image || `https://placehold.co/600x400`" class="img-fluid rounded-3"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h3">
                                ...
                                <span class="text-danger" v-if="product.salePrice"> ${{ product.salePrice }}
                                </span>
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <span class="badge text-bg-secondary p-2" v-for="(tag, index) in product.tags"
                                        :key="index">{{ tag }}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <a href="mailto:mazenmuhammed52@gmail.com" type="button" class="btn btn-success">Contact Us</a>
